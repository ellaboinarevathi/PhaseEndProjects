...
<h2>Patients</h2>
	...
	<input type="submit" value="Search Patients" class="btn btn-secondary">
	</form>
	</br>
	<form action="addPatients.jsp">
	<input type="submit" value="Add Patients" class="btn btn-secondary">
	</form>
	</br>
